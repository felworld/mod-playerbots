...
public:
    TriggerContext()
    {
        ...
        creators["enemy fc spotted"] = &TriggerContext::enemy_fc_spotted;
...
private:
    ...
    static Trigger* enemy_fc_spotted(PlayerbotAI* botAI) { return new EnemyFlagCarrierSpottedTrigger(botAI); }
