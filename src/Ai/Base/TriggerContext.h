...
public:
    TriggerContext()
    {
        ...
        creators["master is resting"] = &TriggerContext::MasterIsResting;
        ...
        creators["stealthed approach"] = &TriggerContext::stealthed_approach;
        ...
        creators["distracted"] = &TriggerContext::distracted;
        ...
        creators["enemy near own flag room"] = &TriggerContext::enemy_near_own_flag_room;
        ...
        creators["wpvp truce salute"] = &TriggerContext::wpvp_truce_salute;
        creators["wpvp avoid killer"] = &TriggerContext::wpvp_avoid_killer;
...
private:
    ...
    static Trigger* trade_deal_pending(PlayerbotAI* botAI) { return new TradeDealPendingTrigger(botAI); }
    ...
    static Trigger* MasterIsResting(PlayerbotAI* botAI) { return new MasterIsRestingTrigger(botAI); }
    ...
    static Trigger* stealthed_approach(PlayerbotAI* botAI) { return new StealthedApproachTrigger(botAI); }
    ...
    static Trigger* distracted(PlayerbotAI* botAI) { return new DistractedTrigger(botAI); }
    ...
    static Trigger* enemy_near_own_flag_room(PlayerbotAI* botAI) { return new EnemyNearOwnFlagRoomTrigger(botAI); }
    ...
    static Trigger* wpvp_truce_salute(PlayerbotAI* botAI) { return new WpvpTruceSaluteTrigger(botAI); }
    static Trigger* wpvp_avoid_killer(PlayerbotAI* botAI) { return new WpvpAvoidKillerTrigger(botAI); }
