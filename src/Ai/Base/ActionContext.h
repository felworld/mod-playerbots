...
public:
    ActionContext()
    {
        ...
        creators["dungeon hold attack"] = &ActionContext::dungeon_hold_attack;
        ...
        creators["shake off distract"] = &ActionContext::shake_off_distract;
        ...
        creators["announce incoming"] = &ActionContext::announce_incoming;
...
private:
    ...
    static Action* shake_off_distract(PlayerbotAI* botAI) { return new ShakeOffDistractAction(botAI); }
    ...
    static Action* dungeon_hold_attack(PlayerbotAI* botAI) { return new DungeonHoldAttackAction(botAI); }
    ...
    static Action* announce_incoming(PlayerbotAI* botAI) { return new WsgAnnounceIncomingAction(botAI); }
